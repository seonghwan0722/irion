...
def generate_launch_description():
    ...
    # 2. Lifecycle Manager 실행 (Map Saver 관리용)
    ...
    # 4. Navigation Stack 실행 (NavigateToPose 액션을 사용하기 위해 필요)
    # 이 부분이 추가되어야 src/ats_system1/navigation.py 가 정상 작동함
