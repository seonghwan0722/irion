...
LOCAL_MODEL = os.getenv("LOCAL_MODEL_NAME", "llama3")
LOCAL_MODEL_PATH = os.getenv("LOCAL_MODEL_PATH", "models/llama-3-8b.Q4_K_M.gguf")
...
# state_text 와 extra_context_text를 합쳐서 실행하는 함수
def build_plan(
    user_command: str,
